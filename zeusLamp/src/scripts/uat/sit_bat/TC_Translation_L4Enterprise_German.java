...
public class TC_Translation_L4Enterprise_German{
	...
	public void LAMPTest() throws Exception
	{
		try{	
			...
			oASelFW.driver.get("http://aem-test-auth-1.vmware.com:8080/sites.html/content/vmware/language-master-sites/de/my-vmware/onlyAutoQA");
