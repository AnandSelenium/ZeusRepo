...
public class TC_VMworld_US_Interior_SponsorsPage {
	...
	@Test
	public void TC_VMworld_US_Interior_SponsorsPage() throws Exception
	{
		try
		{	
			...
			for(int i=1;i<=2;i++)
			{
				String logo[]= {"slideHero-3.jpg","card-banner.jpg"};
