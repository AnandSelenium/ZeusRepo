...
public class TC_Translation_Cclamp_Germany{
	...
	public void LAMPTest() throws Exception
	{
		try{	
			...
			oASelFW.driver.get("http://aem-uat-auth-1.vmware.com:8080/sites.html/content/vmware/language-master-sites/de/training/uat_qa/onlyAutoQA");

			//Verifying The Created Page 
			aemSitesObj.Verify_CreatedPage(pageName, newName);
			
			//navigating to rollout locale
			oASelFW.driver.get("http://aem-uat-auth-1.vmware.com:8080/sites.html/content/vmware/language-master-sites/de/training/uat_qa");
			aemstranlationObj.selectPage("onlyAutoQA");
			aemComponentObj.clickLiveCopy();
			aemComponentObj.rolloutOps_UAT("/de/training/uat_qa/onlyAutoQA");
			url.VmwarePublishPage("de");
			oASelFW.effecta("waitForPageToLoad");
			Thread.sleep(5000);
			aemstranlationObj.selectPage(pageName);
