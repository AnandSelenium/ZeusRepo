...
public class TC_Translation_Canvas_Portugese{
	...
	public void LAMPTest() throws Exception
	{
		try{	
			...
			String translatedPage=aemstranlationObj.fillFieldsInCreateAndTranslate("Portuguese (Brazil)", "Create a new translation project");
			...
			oASelFW.driver.get("http://aem-uat-auth-1.vmware.com:8080/sites.html/content/vmware/language-master-sites/pt_br/training/uat_qa/onlyAutoQA");

			//Verifying The Created Page 
			aemSitesObj.Verify_CreatedPage(pageName, newName);
			
			//navigating to rollout locale
			oASelFW.driver.get("http://aem-uat-auth-1.vmware.com:8080/sites.html/content/vmware/language-master-sites/pt_br/training/uat_qa");
			aemstranlationObj.selectPage("onlyAutoQA");
			aemComponentObj.clickLiveCopy();
			aemComponentObj.rolloutOps_UAT("/br/training/uat_qa/onlyAutoQA");
			url.VmwarePublishPage("br");
			oASelFW.effecta("waitForPageToLoad");
			Thread.sleep(5000);
			aemstranlationObj.selectPage(pageName);
