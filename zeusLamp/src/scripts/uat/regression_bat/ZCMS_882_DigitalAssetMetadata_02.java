...
public class ZCMS_882_DigitalAssetMetadata_02 {
ArsinSeleniumAPI oASelFW = null;
	...
	public void LAMPTest() throws Exception
	{
		...
		{	
			...
			String metaTagNames[]={"Journey Stage","Internal Engagement Channel","Personas"};
			String[] details={"","None",""};
			...
			Thread.sleep(15000);
			aemPageCreateObj.edit_MetaDataProperties_None("None");
