...
ArsinSeleniumAPI oASelFW = null;
	...
	public void LAMPTest() throws Exception{
		try{	
			...
			String metaTagNames[]={"Page Content Type","Journey Stage","Internal Engagement Channel","Score","Personas","Entitlement Type"};
			String[] details={"Non Form","Awareness","Contact Sales Form","5","Technical Influence","Partner"};
			...
			//aemComponentObj.VerifyPublishPage_MessageDisplayed();
		...
		/*	String pageSource=aemPageCreateObj.getPageSource();
			
			aemPageCreateObj.verifyPageSource(details, pageSource,metaTagNames);*/
