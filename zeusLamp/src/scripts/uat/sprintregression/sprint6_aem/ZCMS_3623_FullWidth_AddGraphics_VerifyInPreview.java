...
public class ZCMS_3623_FullWidth_AddGraphics_VerifyInPreview{
	...
	@Test
	public void ZCMS_3623_FullWidth_AddGraphics_VerifyInPreview() throws Exception
	{
		...
		try{	
			...
			//Verify Image
			aemComponentsObj.VerifyImage("slideHero-3.jpg");
