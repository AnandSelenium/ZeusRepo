...
public class TC_ZCMS_3800_Verifying_Internal_External_Link {
	...
	@Test
	public void TC_ZCMS_3800_Verifying_Internal_External_Link() throws Exception{
		...
		try{	
			...
			Thread.sleep(4000);
			//oASelFW.driver.get("http://aem-test-auth-1.vmware.com:8080/editor.html/content/vmworld/en/us/QAAutoTest99625.html");
			//Verify Home Page
			...
			//MEenu LInk Screen Shot
			//samp.get_menulinkscreenShot();
			//samp.click_preview();
			...
			Thread.sleep(5000);
			//samp.VerifySubMenuLinks("Australia");
			
			samp.verifyingExternal_InternalLink();
			
			
			/*//VERIFY MENU LINK
			samp.verify_menulinks("Continents");
			samp.verify_menulinks("Countries");*/

			/*//VERIFY SUB-MENU LINKS
			samp.verify_submenulinks("India");
			samp.verify_submenulinks("Australia");*/
