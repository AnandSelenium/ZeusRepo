...
public class TC_ZCMS_3800_Links_Association_To_Menuitems {
	...
	@Test
	public void TC_ZCMS_3800_Links_Association_To_Menuitems() throws Exception{
		...
		try{	
			...
			Thread.sleep(4000);
			//oASelFW.driver.get("http://aem-test-auth-1.vmware.com:8080/editor.html/content/vmworld/en/us/QAAutoTest95739.html");
			//Verify Home Page
