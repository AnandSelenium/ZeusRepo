...
public class TC_ZCMS_4698_CreateSocialShare_US_InteriorPageWithNoCarouselTemplate {
	...
	public void TC_ZCMS_4698_CreateSocialShare_US_InteriorPageWithNoCarouselTemplate() throws Exception{
		...
		try{	
			...
			//Thread.sleep(4000);
			//oASelFW.driver.get("http://aem-test-auth-1.vmware.com:8080/editor.html/content/vmworld/en/us/QAAutoTest97902.html");
