...
public class TC_ZCMS_4698_CreateSocialShare_EU_WithInteriorPageTemplate {
	...
	@Test
	public void TC_ZCMS_4698_CreateSocialShare_EU_WithInteriorPageTemplate() throws Exception{
		...
		try{	
			...
			//TC_ZCMS_4698_CreateSocialShare_US_InteriorPageTemplate
			...
			/*Thread.sleep(4000);
			oASelFW.driver.get("http://aem-test-auth-1.vmware.com:8080/editor.html/content/vmworld/en/europe/global-content/onlyAutoQA/QAAutoTest8058.html");
*/
			//Verify Home Page
		...
		/*	Thread.sleep(5000);
			...
			*/
			...
			String link_ImageALTText[]= {"Facebook_Alt","Twitter_Alt","LinkedIn_Alt","Youtube_Alt"};
				...
				aemComponentsObj.verify_SocialShare_Values_US_InteriorPage(link_ImageALTText[0],link_Label[0],1);	//facebook
				aemComponentsObj.verify_SocialShare_Values_US_InteriorPage(link_ImageALTText[1],link_Label[1],2);	//Twitter
				aemComponentsObj.verify_SocialShare_Values_US_InteriorPage(link_ImageALTText[2],link_Label[2],3);	//LinkedIn
				aemComponentsObj.verify_SocialShare_Values_US_InteriorPage(link_ImageALTText[3],link_Label[3],4);	//Youtube
				
				
				//Click on Social Media Channel
				aemComponentsObj.ClickOn_SocialShare_Values_US_InteriorPage(link_ImageALTText[0],link_BrowseSocialMedia_Url[0],1,link_Label[0]);	//facebook
				aemComponentsObj.ClickOn_SocialShare_Values_US_InteriorPage(link_ImageALTText[1],link_BrowseSocialMedia_Url[1],2,link_Label[1]);	//Twitter
				aemComponentsObj.ClickOn_SocialShare_Values_US_InteriorPage(link_ImageALTText[2],link_BrowseSocialMedia_Url[2],3,link_Label[2]);	//LinkedIn
				aemComponentsObj.ClickOn_SocialShare_Values_US_InteriorPage(link_ImageALTText[3],link_BrowseSocialMedia_Url[3],4,link_Label[3]);	//Youtube 
