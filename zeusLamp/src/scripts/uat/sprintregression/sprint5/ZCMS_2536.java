...
public class ZCMS_2536{
	...
	public void LAMPTest()
	{
		try{	
			...
			String customerStory=aemCustStoryObj.createCustomerStory_Uat(customerName);
			...
			//Deleting customer Story
			aemCustStoryObj.delete_CustomerStory(customerStory);
			Thread.sleep(5000);
			
			//Again Verifying The Search
			aemCustStoryObj.Search(customerStory);
