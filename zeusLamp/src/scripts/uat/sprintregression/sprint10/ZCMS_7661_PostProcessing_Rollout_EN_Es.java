...
public class ZCMS_7661_PostProcessing_Rollout_EN_Es {
	...
	@Test
	public void ZCMS_7661_PostProcessing_Rollout_EN_Es() throws Exception{
		try{	
			...
			String translatedPage=aemstranlationObj.fillFieldsInCreateAndTranslate("Spanish", "Create a new translation project");
			...
			langMapp.SelectTranslationLocale("Spain");
			...
			langMapp.EnterTargetLanguageID("CTA Title_SP");
			...
			langMapp.EnterTargetLanguageID("https://www.vmware.sp.com");
			...
			aemLoginObj.openURL("http://aem-test-auth-1.vmware.com:8080/sites.html/content/vmware/language-master-sites/es");
			Thread.sleep(10000);
			...
			//Click Page path
			aemstranlationObj.clickLiveCopyShortPath("/es/my-vmware");
			...
			aemSitesObj.SelectSearchDirectory("/content/vmware/vmware-published-sites/es/my-vmware/onlyAutoQA");
			...
			aemstranlationObj.verifyRolloutPagedata("CTA Title_SP");
			Thread.sleep(5000);
