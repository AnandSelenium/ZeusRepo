...
public class ZCMS_7661_PostProcessing_Rollout_EN_FR {
	...
	public void test() throws Exception{
		try{	
			...
			aemLoginObj.openURL("http://aem-test-auth-1.vmware.com:8080/sites.html/content/vmware/language-master-sites/fr");
			Thread.sleep(10000);
			...
			//Click Page path
			aemstranlationObj.clickLiveCopyShortPath("/fr/my-vmware");
