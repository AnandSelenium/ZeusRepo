...
public class  ZCMS_7834_EnhanceRTE_DisclaimerText_GoogleMap{
	...
	public void test() throws Exception
	{
		try{	
			...
			System.out.println("Contact Us With Google Maps");
			aemComponentObj.clickOnTabPanelLinks("Components");
			aemComponentObj.enterTextInput("Contact Us With Google Maps", "Components");
			aemComponentObj.dragAndDropComponents("Contact Us With Google Maps", "Components","");
			
	
			//Click on Rich Text Component
			aahp.clickOnRichTextComponent("Contact Us With Google Maps");
