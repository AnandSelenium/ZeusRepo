...
public class ZCMS_4623_English{
	...
	public void LAMPTest() throws Exception
	{
		try{	
			...
			//click Rollout Page
			aemEditObj.click_rolloutPage();
			Thread.sleep(3000);
			
			//select link
			//aemEditObj.selectSite();
			...
			//Rolled Out Locale
			oASelFW.driver.get("http://aem-uat-auth-1.vmware.com:8080/sites.html/content/vmware/language-master-sites/en/training/uat_qa/onlyAutoQA");
