...
public class  ZCMS_4855_Create_ChevronCTA_In_TwoColumnContainer{
	...
	@Test
	public void ZCMS_4855_Create_ChevronCTA_In_TwoColumnContainer() throws Exception
	{
		try{	
		...
		//	oASelFW.driver.get("http://aem-test-auth-1.vmware.com:8080/editor.html/content/vmware/language-master-sites/en/my-vmware/QAAutomationTest/QAAuto39511.html");
			...
			aemComponentObj.ClickInsertNewComponent_DropdownOption("Two Column Container");

			//Double Click on Inserted Component
			aemComponentObj.DoubleClickOnComponent("columncontainer");
			
			aemComponentObj.EnterTextField("Title ","TestContainer"); //Enter Title for Two Column Container
			
			aemComponentObj.SelectRequiredOption("Select the Background Color","Light Gray");	//Select the Background Color
			
			aemComponentObj.SelectRequiredOption("Select the Background Gradiant color","HighlightFeature/SpotLight - Blue");	//Select the Background Gradiant color
			
			aemComponentObj.SelectRadioButton_Yes();	//Select Radio button 'Yes'
			
			aemComponentObj.SelectRequiredOption("Select the border width type","Thick");	//Select the border width type
			...
			//Click on Drag Components here
			aemComponentObj.Click_TwoColumnContainer_DragComponents();
			
			Thread.sleep(5000);
			
			//Click on Insert New Component drop down option
			aemComponentObj.ClickInsertNewComponent_DropdownOption("Rich Text");
			...
			cfp.insertTextInRichTextComponentWhenMaxmized("SampleTestForChevron");
			...
			aemComponentObj.MoveCursorToEnd_RobotKeys();
			...
			//Verify Style Type
			aemComponentObj.Verify_RichText_StyleType("Chevron");
			
			//Click Style Type
			aemComponentObj.Click_RichText_StyleType("Chevron");
			...
			//Verify Rich Text Entered Value is Configured with Chevron in preview mode
			aemComponentObj.Verify_RichText_ChevronCTA("SampleTestForChevron","Read Mode");
			...
			//Verify Rich Text Entered Value is Configured with Chevron in preview mode
			aemComponentObj.Verify_RichText_ChevronCTA("SampleTestForChevron","Preview Mode");
			...
			//Verify Rich Text Entered Value in publish mode
			aemComponentObj.Verify_RichText_ChevronCTA_InContentMode("SampleTestForChevron","Publish Mode");
