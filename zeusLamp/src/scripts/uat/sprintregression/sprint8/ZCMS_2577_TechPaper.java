...
public class ZCMS_2577_TechPaper{
	...
	public void LAMPTest() throws Exception
	{
		try{	
			...
			//Enter Publisher
			aemComponentObj.EnterTextField("Enter Publisher Value", "VMware");
			...
			aemComponentObj.verifyTechPapersValues("VMware");
			//aemComponentObj.verifyTechPapersValues("March 24, 2016");
			...
			//Enter Publisher
			aemComponentObj.EnterTextField("Enter Publisher Value", "Prolifics");
			...
			aemComponentObj.verifyTechPapersValues("Prolifics");
