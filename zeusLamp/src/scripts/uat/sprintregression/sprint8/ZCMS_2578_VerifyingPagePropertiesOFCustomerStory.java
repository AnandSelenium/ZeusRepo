...
public class ZCMS_2578_VerifyingPagePropertiesOFCustomerStory{
	...
	public void LAMPTest() throws Exception
	{
		try{	
			...
			//Click On Website
			aemClassicObj.click_WebSite_Tools();
			
			//Click On Customers
			aemClassicObj.click_mainFolder("customer-stories");
			
			aemCustStoryObj.clickOnModified();
			
			aemCustStoryObj.clickOnProperitiesOfCustStory(customerStory[0]);
			
			aemCustStoryObj.clickOnPagePropTab("Customer Story Information");
			
			aemCustStoryObj.verifyCustomerStoryValues("PDF");
			
			aemCustStoryObj.verifyCustomerLinkValues("Link Title",customerStory[1]);
			
			aemCustStoryObj.verifyCustomerLinkValues("Link Url",customerStory[2]);
