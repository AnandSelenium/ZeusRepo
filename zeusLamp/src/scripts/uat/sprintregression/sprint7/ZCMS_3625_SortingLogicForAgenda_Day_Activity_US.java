...
public class ZCMS_3625_SortingLogicForAgenda_Day_Activity_US {
	...
	public void ZCMS_3625_US() throws Exception{
		try{	
			...
			aemComponentsObj.enterTextInput("Agenda Header", "Components");
			
			aemComponentsObj.dragAndDropComponents("Agenda Header", "Components","");
			...
			String viewDays[]={"Saturday August 29","Sunday August 30","Monday August 31"};
