...
public class ZCMS_4700_EU {
	...
	public void TC_ZCMS_3798_SiteHeader_SiteLinks_USInteriorpageWithNo_CarouselTemplate() throws Exception
	{
		...
		{	
			...
			oASelFW.driver.get("http://search.vmware.com/search?site=VMworld_eu&client=VMworld_eu&proxystylesheet=VMworld_eu&num=5&q=vsphere");
			Thread.sleep(5000);
