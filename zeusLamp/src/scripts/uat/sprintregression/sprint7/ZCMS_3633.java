...
public class ZCMS_3633 {
	...
	public void TC_ZCMS_3798_SiteHeader_SiteLinks_USInteriorpageWithNo_CarouselTemplate() throws Exception
	{
		...
		{	
			...
			String tabHeader[]={"GlobalDiamond","GlobalPlatinum","Platinum","Gold"};
			...
			cfp.sponsorHeader("sponsor-1");
			
			//sponsor Component
			cfp.enterComponentDetails("Sponsor Title","HP");
			cfp.enterLogo("Logo","/content/dam/digitalmarketing/vmworld/images/sponsor_logo_hp.jpg");
			cfp.enterComponentDetails("Logo Alt Text","HP Alt Text");
			cfp.enterLogo("Logo UrL","http://www.hp.com/");
			cfp.selectWindow("Select URL Open type","Same Window");
			cfp.enterComponentDetails("Sponsor Banner Alt Text","hp Alt Text");
			cfp.enterLogo("Sponsor Banner","http://download3.vmware.com/vmworld/2015/images/banner-sponsor-hp.png");
			cfp.enterDescription("Description","Description");
			cfp.clickOnDone();
			...
			aemSponsorPage.VerifySponsorRespectiveLogoBelowHeading("GlobalDiamond","/content/dam/digitalmarketing/vmworld/images/sponsor_logo_hp.jpg");
