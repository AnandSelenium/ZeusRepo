...
public class ZCMS_13595_HomePageTemplate_TwoColumnContainer{
	...
	public void LAMPTest() throws Exception
	{
		try{	
			...
			aemComponentsObj.SelectRequiredOption("Select the Skin Type","Vertical Thick Border Left (Blue)");	//Select the Background Gradiant color		
