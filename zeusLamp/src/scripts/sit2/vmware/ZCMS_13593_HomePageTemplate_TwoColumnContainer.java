...
public class ZCMS_13593_HomePageTemplate_TwoColumnContainer{
	...
	public void LAMPTest() throws Exception
	{
		try{	
			...
			aemComponentsObj.SelectRequiredOption("Select the Background Color","Solid white (Default)");	//Select the Background Color	
			aemComponentsObj.SelectRequiredOption("Select the Skin Type","Vertical Thick Border Left (Green)");	//Select the Background Gradiant color		
			aemComponentsObj.SelectRequiredOption("Border","Yes");		//Select Radio button 'Yes'
			aemComponentsObj.containerLinkLabel();
			...
			aemComponentObj.verifyHeading("Test");
