...
public class TC_Lamp_CustomerStory_English_BrightCovee{
	...
	public void LAMPTest()
	{
		try{	
			...
			String[] customerStory=aemCustStoryObj.CustomerStory_Sit("en","Brightcove","English","VMware-Horizon-Suite-FAQ.pdf");
