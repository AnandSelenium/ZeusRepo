...
public class TC_Lamp_CustomerFolder {
	...
	public void test() throws Exception{
		...
		try{	
			...
			aemSitesObj.Verify_CreatedPage("customers", "");
			aemSitesObj.clickOnRequiredSite("customers");
			...
			for(int i=1,j=0;i<=count;i++,j++)
			{
				...
				alpha[j]=oASelFW.effecta("getText","xpath=(//h4[contains(@itemprop,'title')])["+i+"]");
