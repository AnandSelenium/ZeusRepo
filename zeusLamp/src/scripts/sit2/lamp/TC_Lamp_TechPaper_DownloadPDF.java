...
public class TC_Lamp_TechPaper_DownloadPDF{
	...
	public void LAMPTest() throws Exception
	{
		try{	
			...
			Thread.sleep(60000);
			aemSitesObj.clickOnRequiredSite("Technical Papers");
			aemSitesObj.clickOnRequiredSite("2015");
			...
			//Download Pdf
			aemComponentsObj.clickDownloadPdf();
			Thread.sleep(50000);
