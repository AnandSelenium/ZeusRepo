...
public class VMworld_US_Interior_SpecialityGraphics_4{
	...
	@Test
	public void VMworld_US_Interior_SpecialityGraphics_4() throws Exception
	{
		...
		try{	
			...
			aemComponentsObj.enterTextInput("Specialty Graphics", "Components");
			Thread.sleep(5000);
			
			aemComponentsObj.dragAndDropComponents("Specialty Graphics", "Components","");
			...
			for(int i=1;i<5;i++)
			{
				...
				String link_ImageALTText[]= {"AltText1","AltText2","AltText3","AltText4"};
