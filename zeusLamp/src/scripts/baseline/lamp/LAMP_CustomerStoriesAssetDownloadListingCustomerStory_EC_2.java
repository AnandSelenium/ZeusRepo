...
public class LAMP_CustomerStoriesAssetDownloadListingCustomerStory_EC_2{
	...
	public void LAMPTest() throws Exception
	{
		try{	
			...
			String[] customerStory=aemCustStoryObj.CustomerStory_Sit("en","Brightcove","English","Payment-Adviser-Infographic.pdf");
