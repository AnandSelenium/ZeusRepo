...
public class Translation_L4Enterprise_Korean{
	...
	public void LAMPTest() throws Exception
	{
		try{	
			...
			String translatedPage=aemstranlationObj.fillFieldsInCreateAndTranslate("Korean", "Create a new translation project");
			...
			oASelFW.driver.get("http://aem-test-auth-1.vmware.com:8080/sites.html/content/vmware/language-master-sites/ko/my-vmware/onlyAutoQA");
