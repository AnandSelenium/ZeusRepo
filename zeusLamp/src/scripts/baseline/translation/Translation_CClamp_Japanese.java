...
public class Translation_CClamp_Japanese{
	...
	public void LAMPTest() throws Exception
	{
		try{	
			...
			oASelFW.driver.get("http://aem-test-auth-1.vmware.com:8080/sites.html/content/vmware/language-master-sites/ja/my-vmware/onlyAutoQA");
