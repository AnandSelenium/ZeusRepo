...
public class Translation_CClamp_Hebrew{
	...
	public void LAMPTest() throws Exception
	{
		try{	
			...
			String translatedPage=aemstranlationObj.fillFieldsInCreateAndTranslate("Hebrew", "Create a new translation project");
			...
			oASelFW.driver.get("http://aem-test-auth-1.vmware.com:8080/sites.html/content/vmware/language-master-sites/he/my-vmware/onlyAutoQA");
