package scripts.aem_phase2.aug19hotfixrelease;
...
public class ZCMS_17737_AddReleaseTags{
	...
	@Test
	public void ZCMS_17737_AddReleaseTags() throws Exception
	{
		
		String pageName=null;
		try{	
			oASelFW.driver.manage().timeouts().pageLoadTimeout(500, TimeUnit.SECONDS);
			AEMAssetsPage aemAssetsObj				=	new AEMAssetsPage(oASelFW);
			...
			aemAssetsObj.selectPage_ViewProperties(pagename);
			
			aemAssetsObj.clickViewProperties_Edit();
			
			aemAssetsObj.clickViewProperties_ReleaseTags_Browse();
			
			aemAssetsObj.clickViewPropertiesReleaseTags("VMware");
			aemAssetsObj.clickViewPropertiesReleaseTags("Release Tags");
			aemAssetsObj.clickViewPropertiesReleaseTags("Release July");
			
			aemAssetsObj.clickReleaseTags_SaveIcon();

			aemAssetsObj.clickViewProperties_Done();
