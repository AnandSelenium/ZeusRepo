package scripts.aem_phase2.dmr.aug19hotfixrelease_prod;
...
public class ZCMS_17669_VMworld_BrightCoveID_Support{
	...
	public void oneTimeSetUp(String prjName,String testEnvironment,String instanceName,String sauceUser,String moduleName,String testSetName) throws InterruptedException
	{
		...
		oASelFW.startSelenium(oASelFW.getURL("AEM_URL_Prod",oASelFW.instanceName));	
	}
	@Test
	public void ZCMS_17669_VMworld_BrightCoveID_Support() throws Exception
	{
		...
		try{	
			...
			Thread.sleep(4000);
			oASelFW.driver.get("http://aem-prod.vmware.com/editor.html/content/vmworld/en/us/learning/Aug19RelSmokeTest.html");
