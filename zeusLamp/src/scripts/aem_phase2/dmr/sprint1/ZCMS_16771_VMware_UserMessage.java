...
public class ZCMS_16771_VMware_UserMessage{
	...
	@Test
	public void ZCMS_16771_VMware_UserMessage() throws Exception
	{
		try{	
			...
			aemComponentObj.enterTextInput("User message", "Components");
			aemComponentObj.dragAndDropComponents("User message", "Components","");
			aemComponentObj.clickOnToggleSidePanel();
			Thread.sleep(5000);
			
			aahp.clickInsertedComponent("");
