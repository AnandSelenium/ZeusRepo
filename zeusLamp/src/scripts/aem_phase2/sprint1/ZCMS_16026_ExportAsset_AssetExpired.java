...
public class ZCMS_16026_ExportAsset_AssetExpired{
	...
	@Test
	public void ZCMS_16026_ExportAsset_AssetExpired()
	{
		try{	
			...
			aemComponentObj.AssetReport_SelectReportOption("Select Report","Asset Expired");
			Thread.sleep(10000);
			//Click on Date Range
			aemComponentObj.clickAssetReport_DateRange("In The Next");
			Thread.sleep(8000);
			//Enter Start Date and time
			aemComponentObj.EnterAssetReport_AssetExpiredDateRange_DateTime("In The Next","Start Date","2016-07-26 00:00");
			
			
			//Enter End Date and time
			aemComponentObj.EnterAssetReport_AssetExpiredDateRange_DateTime("In The Next","End Date","2016-08-03 00:00");
