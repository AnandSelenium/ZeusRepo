...
public class ZCMS_16027_AssetTranslation_Br{
	...
	public void LAMPTest() throws Exception
	{
		try{	
			...
			aemstranlationObj.selectsourceLanguage("Portuguese (Brazil) (pt_br)");
			Thread.sleep(30000);
			aemstranlationObj.selectValue("Target Languages","ja");
			...
			Thread.sleep(10000);
			String url=aemSitesObj.getPageurl("ja");
