...
public class ZCMS_9831_VMworld_EU_RightHandBanner_Video {
	...
	@Test
	public void ZCMS_9831_VMworld_EU_RightHandBanner_Video() throws Exception{
		...
		try{	
			...
			//oASelFW.driver.get("http://aem-test.vmware.com:8080/sites.html/content/vmworld/en/Europe/");
