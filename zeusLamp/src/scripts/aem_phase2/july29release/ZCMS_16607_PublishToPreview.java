...
public class ZCMS_16607_PublishToPreview{
	...
	public void test() throws Exception
	{
		try{	
			...
			aemComponentsObj.SelectWorkflowModelOption("VMWare Publish To Preview");
			Thread.sleep(3000);
			...
			url.dispURL_Preview(pageName);
			oASelFW.effecta("waitForPageToLoad");
			Thread.sleep(5000);
			
			url.liveUAT_Preview(pageName);
			oASelFW.effecta("waitForPageToLoad");
			Thread.sleep(5000);
