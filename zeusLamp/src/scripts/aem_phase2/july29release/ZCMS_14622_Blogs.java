...
public class  ZCMS_14622_Blogs{
	...
	public void test() throws Exception
	{
		try{	
			...
			Thread.sleep(10000);
			aemComponentObj.enterTextInput("Blogs", "Components");
			Thread.sleep(3000);
			aemComponentObj.dragAndDropComponents("Blogs", "Components","");
			aemComponentObj.clickOnToggleSidePanel();
			Thread.sleep(5000);
			aahp.clickInsertedComponent("blogs");
			aahp.clickOnTool("CONFIGURE");
			Thread.sleep(8000);
			//Configuring the components
			aip.enterValueInInputUponLabel("Blog Heading","VMWare Virtulization Blog-Test");
			aip.enterValueInInputUponLabel("Blog Visit Link Label","Visit the VMwareVirtualizationBlog-Test");
			aip.enterValueInInputLinkUrl("Blog Visit Link URL","https://blogs.vmware.com");
			aip.enterValueInInputLinkUrl("Feed Path","https://www.vmwareblogs.com/rss.xml");
			aahp.clickOnDone();
			//---------------------------------------//---------------------------------//
			...
			aemComponentObj.verifyFullWidthTitle("VMWare Virtulization Blog-Test");
