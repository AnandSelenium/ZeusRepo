 ...
 *
 */
public class AssetValidationV2 {
	...
	public void test() throws Exception
	{
		try{
			...
			ArrayList<String> colNames = utility.getExcelSheetColumnValues(oASelFW.sAutomationPath+"Final.xlsx", 0); // get Column Names
			System.out.println("Col Names"+colNames.size());
			HashMap<String,String[]> listOfLists =utility.readColumnValues(oASelFW.sAutomationPath+"Final.xlsx",colNames);
