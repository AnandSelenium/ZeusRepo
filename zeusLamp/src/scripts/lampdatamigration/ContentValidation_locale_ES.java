...
public class ContentValidation_locale_ES{
	...
	public void oneTimeSetUp(String prjName,String testEnvironment,String instanceName,String sauceUser,String moduleName,String testSetName) throws InterruptedException
	{
		...
		oASelFW.startSelenium(oASelFW.getURL("Content_Validation_URL_es",oASelFW.instanceName));	
	}
	...
	public void ContentValidation_locale_ES() throws Exception
	{
		...
		try
		{
			...
			String[] urls = utlmthds.getValuesFromPropertiesFile("constant","Content_Validation_URL_es").split(",");
