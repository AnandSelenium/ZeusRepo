...
public class TC_VMworld_US_NonInterior_AddSponsorsTabs4_Logos2 {
	...
	@Test
	public void TC_VMworld_US_NonInterior_AddSponsorsTabs4_Logos2() throws Exception
	{
		try
		{	
			...
			*/
			...
			String tabHeader[]={"Exhibitor","GoldLevel","GlobalDiamond","VMware"};
			...
			for(int i=1;i<=2;i++)
			{
				String logo[]= {"Lighthouse.jpg","Lighthouse.jpg"};
