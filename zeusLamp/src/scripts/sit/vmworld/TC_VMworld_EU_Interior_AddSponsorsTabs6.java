...
public class TC_VMworld_EU_Interior_AddSponsorsTabs6 {
	...
	@Test
	public void TC_VMworld_EU_Interior_AddSponsorsTabs6() throws Exception
	{
		try
		{	
			...
			for(int i=1;i<2;i++)
			{
				String logo[]= {"supermicro.png","supermicro.png","supermicro.png","supermicro.png","supermicro.png","supermicro.png"};
