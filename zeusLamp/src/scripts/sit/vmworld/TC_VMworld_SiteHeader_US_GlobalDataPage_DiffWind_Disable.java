...
public class TC_VMworld_SiteHeader_US_GlobalDataPage_DiffWind_Disable {
	...
	@Test
	public void TC_VMworld_SiteHeader_US_GlobalDataPage_DiffWind_Disable() throws Exception{
		...
		try{	
			...
			for(int i=1;i<=4;i++)
			{
				...
				String linkLabels[]={"Facebook","Twitter","LinkedIn","Youtube"};
				String linkURls[]={"https://www.facebook.com","https://twitter.com/login","https://www.linkedin.com/","https://www.youtube.com/"};
			...
			String linkURls1[]={"https://www.facebook.com","https://twitter.com/login","https://www.linkedin.com/","https://www.youtube.com/"};
			
			
			//verifying added links
			String linkLabels1[]={"Facebook","Twitter","LinkedIn","Youtube"};
