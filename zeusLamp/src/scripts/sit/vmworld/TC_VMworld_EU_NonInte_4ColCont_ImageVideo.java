...
public class TC_VMworld_EU_NonInte_4ColCont_ImageVideo{
	...
	@Test
	public void TC_VMworld_EU_NonInte_4ColCont() throws Exception
	{
		...
		try{	
			...
			//Entering Details
			aemComponentsObj.columnControlDetails("4 columns(25%, 25%, 25%, 25%)");
			...
			aemComponentsObj.ClickOnComponent("field1/video");
			...
			aemComponentsObj.enterTextInput("Lighthouse.jpg", "Assets");
			Thread.sleep(5000);
			...
			//Verify Image
			aemComponentsObj.VerifyImage("Lighthouse.jpg");
