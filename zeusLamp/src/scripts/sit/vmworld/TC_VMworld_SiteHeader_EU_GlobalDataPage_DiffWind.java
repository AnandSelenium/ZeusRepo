...
public class TC_VMworld_SiteHeader_EU_GlobalDataPage_DiffWind {
	...
	@Test
	public void TC_VMworld_SiteHeader_EU_GlobalDataPage_DiffWind() throws Exception{
		...
		try{	
			...
			for(int i=1;i<=1;i++)
			{
				...
				String linkURls[]={"https://www.facebook.com","https://twitter.com/login","https://www.linkedin.com/","https://www.youtube.com/","https://www.vmware.com","https://www.vmworld.com"};
			...
			String linkURls1[]={"https://www.facebook.com","https://twitter.com/login","https://www.linkedin.com/","https://www.youtube.com/","https://www.vmware.com","https://www.vmware.com"};
			...
			aemComponentsObj.click_SiteHeader_DifferentWind_InPreview(linkLabels1[4],linkURls1[4]);
			aemComponentsObj.click_SiteHeader_DifferentWind_InPreview(linkLabels1[5],linkURls1[5]);*/
