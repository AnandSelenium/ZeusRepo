...
public class TC_VMworld_US_NonInterior_AddSponsorsTabs6_Logos2 {
	...
	@Test
	public void TC_VMworld_US_NonInterior_AddSponsorsTabs6_Logos2() throws Exception
	{
		try
		{	
			...
			aahp.insertTextInRichTextComponent("Zeus");		
			aemComponentsObj.SingleClickOnSponsorsComponent("Sponsors Header (Manual approach)");
			Thread.sleep(2000);
			...
			String tabHeader[]={"Exhibitor","GoldLevel","GlobalDiamond","VMworldSponser","VMware","Levels"};
			...
			for(int i=1;i<=2;i++)
			{
				String logo[]= {"supermicro.png","supermicro.png"};
				...
				aemComponentsObj.dragAndDropComponents_MultiField_Sponsors("", "Assets","Logo",i);
			...
			aemComponentsObj.DoubleClickOnRequiredTabcontentComponent("sponsor-3");
			...
			//click on inserted site header component
			aemComponentsObj.DoubleClickOnComponent("sponsor-3/sponsorlogos");
			oASelFW.effecta("waitForPageToLoad");
			Thread.sleep(5000);
			...
			aemComponentsObj.DoubleClickOnRequiredTabcontentComponent("sponsor-4");
			...
			//click on inserted site header component
			aemComponentsObj.DoubleClickOnComponent("sponsor-4/sponsorlogos");
			oASelFW.effecta("waitForPageToLoad");
			Thread.sleep(5000);
			...
			aemComponentsObj.DoubleClickOnRequiredTabcontentComponent("sponsor-5");
			...
			//click on inserted site header component
			aemComponentsObj.DoubleClickOnComponent("sponsor-5/sponsorlogos");
			oASelFW.effecta("waitForPageToLoad");
			Thread.sleep(5000);
			...
			aemComponentsObj.DoubleClickOnRequiredTabcontentComponent("sponsor-6");
			...
			//click on inserted site header component
			aemComponentsObj.DoubleClickOnComponent("sponsor-6/sponsorlogos");
			oASelFW.effecta("waitForPageToLoad");
			Thread.sleep(5000);
			...
			//Click on GlobalDiamond
			aemSponsorPage.ClickSponsorHeading_InPreviewMode("GlobalDiamond");
			
			aemSponsorPage.verify_Sponsors_ListImages(logo[0],"GlobalDiamond",1);
			aemSponsorPage.verify_Sponsors_ListImages(logo[1],"GlobalDiamond",2);
			
			//Click on VMworldSponser
			aemSponsorPage.ClickSponsorHeading_InPreviewMode("VMworldSponser");
			
			aemSponsorPage.verify_Sponsors_ListImages(logo[0],"VMworldSponser",1); 
			aemSponsorPage.verify_Sponsors_ListImages(logo[1],"VMworldSponser",2); 
			
			//Click on VMware
			aemSponsorPage.ClickSponsorHeading_InPreviewMode("VMware");
			
			aemSponsorPage.verify_Sponsors_ListImages(logo[0],"VMware",1); 
			aemSponsorPage.verify_Sponsors_ListImages(logo[1],"VMware",2); 
			
			
			//Click on Levels
			aemSponsorPage.ClickSponsorHeading_InPreviewMode("Levels");
			
			aemSponsorPage.verify_Sponsors_ListImages(logo[0],"Levels",1); 
			aemSponsorPage.verify_Sponsors_ListImages(logo[1],"Levels",2); 
			...
			//Click on GlobalDiamond
			aemSponsorPage.ClickSponsorHeading_InPublishMode("GlobalDiamond");
			
			aemSponsorPage.verify_Sponsors_ListImages_InpublishMode(logo[0],"GlobalDiamond",1);
			aemSponsorPage.verify_Sponsors_ListImages_InpublishMode(logo[1],"GlobalDiamond",2);
			
			//Click on VMworldSponser
			aemSponsorPage.ClickSponsorHeading_InPublishMode("VMworldSponser");
			
			aemSponsorPage.verify_Sponsors_ListImages_InpublishMode(logo[0],"VMworldSponser",1); 
			aemSponsorPage.verify_Sponsors_ListImages_InpublishMode(logo[1],"VMworldSponser",2); 
			//Click on VMware
			aemSponsorPage.ClickSponsorHeading_InPublishMode("VMware");
			
			aemSponsorPage.verify_Sponsors_ListImages_InpublishMode(logo[0],"VMware",1); 
			aemSponsorPage.verify_Sponsors_ListImages_InpublishMode(logo[1],"VMware",2); 
			
			
			//Click on Levels
			aemSponsorPage.ClickSponsorHeading_InPublishMode("Levels");
			
			aemSponsorPage.verify_Sponsors_ListImages_InpublishMode(logo[0],"Levels",1); 
			aemSponsorPage.verify_Sponsors_ListImages_InpublishMode(logo[1],"Levels",2); 
