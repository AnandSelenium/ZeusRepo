...
public class TC_VMworld_US_Interior_2ColControl_HtmlText{
	...
	@Test
	public void TC_VMworld_US_Interior_2ColControl_HtmlText() throws Exception
	{
		...
		try{	
			...
			aemComponentsObj.VerifyEntered_Title("2 Column");
