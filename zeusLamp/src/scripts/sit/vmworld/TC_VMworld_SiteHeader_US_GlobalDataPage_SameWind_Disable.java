...
public class TC_VMworld_SiteHeader_US_GlobalDataPage_SameWind_Disable {
	...
	@Test
	public void TC_VMworld_SiteHeader_US_GlobalDataPage_SameWind_Disable() throws Exception{
		...
		try{	
			...
			for(int i=1;i<=5;i++)
			{
				...
				String linkLabels[]={"Facebook","Twitter","LinkedIn","Youtube","VMware"};
				...
				aemComponentsObj.SelectMultiRequiredOption("Highlight link","Disable",i);  //Select URL Open type
			}
			...
			String linkLabels1[]={"Facebook","Twitter","LinkedIn","Youtube","VMware"};
		...
		/*	Thread.sleep(10000);
			...
			*/
			...
			String linkURls1_Publish[]={"en"};
			
			aemComponentsObj.click_SiteHeader_SameWind_InPublishMode(linkLabels1[0],linkURls1_Publish[0]);
			aemComponentsObj.click_SiteHeader_SameWind_InPublishMode(linkLabels1[1],linkURls1_Publish[0]);
			aemComponentsObj.click_SiteHeader_SameWind_InPublishMode(linkLabels1[2],linkURls1_Publish[0]);
			aemComponentsObj.click_SiteHeader_SameWind_InPublishMode(linkLabels1[3],linkURls1_Publish[0]);
			aemComponentsObj.click_SiteHeader_SameWind_InPublishMode(linkLabels1[4],linkURls1_Publish[0]);
