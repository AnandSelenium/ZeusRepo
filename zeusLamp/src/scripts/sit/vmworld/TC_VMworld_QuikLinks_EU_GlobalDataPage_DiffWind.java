...
public class TC_VMworld_QuikLinks_EU_GlobalDataPage_DiffWind {
	...
	@Test
	public void TC_VMworld_QuikLinks_EU_GlobalDataPage_DiffWind() throws Exception{
		...
		try{	
			...
			String Notifications_DevUrl_modified = utility.getValuesFromPropertiesFile("constant", "Notifications_DevUrl_modified");
			...
			String links[]= {"https://www.vmware.com"};
			...
			aemComponentsObj.click_QuickLinks_DifferentWind_InPreview("QuicklinkText1",links[0]);
			aemComponentsObj.click_QuickLinks_DifferentWind_InPreview("QuicklinkText2",links[0]);
			/*aemComponentsObj.click_QuickLinks_DifferentWind_InPreview("QuicklinkText3",links[0]);
			aemComponentsObj.click_QuickLinks_DifferentWind_InPreview("QuicklinkText4",links[0]);
*/
			...
			//Click on displayed links
			aemComponentsObj.click_QuickLinks_DifferentWind_InPublishMode("QuicklinkText1",links[0]);
			aemComponentsObj.click_QuickLinks_DifferentWind_InPublishMode("QuicklinkText2",links[0]);
			/*aemComponentsObj.click_QuickLinks_DifferentWind_InPublishMode("QuicklinkText3",links[0]);
			aemComponentsObj.click_QuickLinks_DifferentWind_InPublishMode("QuicklinkText4",links[0]);
*/
