...
public class TC_VMworld_EU_Interior_AddSponsorsTabs2_Logos4 {
	...
	@Test
	public void TC_VMworld_EU_Interior_AddSponsorsTabs2_Logos4() throws Exception
	{
		try
		{	
			...
			*/
			...
			for(int i=1;i<=4;i++)
			{
				String logo[]= {"supermicro.png","supermicro.png","supermicro.png","supermicro.png"};
				String logoUrl[]= {"https://www.vmware.com"};
				String LogoAltText[]= {"Alt_Text1","Alt_Text2","Alt_Text3","Alt_Text4"};
			...
			aemSponsorPage.verify_Sponsors_ListImages(logo[2],"GoldLevel",3);
			aemSponsorPage.verify_Sponsors_ListImages(logo[3],"GoldLevel",4);
			...
			aemSponsorPage.verify_Sponsors_ListImages_InpublishMode(logo[2],"Exhibitor",3);
			aemSponsorPage.verify_Sponsors_ListImages_InpublishMode(logo[3],"Exhibitor",4);
			//Click on GoldLevel
			...
			aemSponsorPage.verify_Sponsors_ListImages_InpublishMode(logo[2],"GoldLevel",3);
			aemSponsorPage.verify_Sponsors_ListImages_InpublishMode(logo[3],"GoldLevel",4);
