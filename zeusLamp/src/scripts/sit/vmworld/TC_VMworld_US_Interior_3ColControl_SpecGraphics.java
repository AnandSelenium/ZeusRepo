...
public class TC_VMworld_US_Interior_3ColControl_SpecGraphics{
	...
	@Test
	public void TC_VMworld_US_Interior_3ColControl_SpecGraphics() throws Exception
	{
		...
		try{	
			...
			aemComponentsObj.VerifyColumnControlTitle("3 Column");
			//Verify Image
