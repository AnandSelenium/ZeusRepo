...
public class TC_VMworld_EU_Interior_3ColControl_HtmlText{
	...
	@Test
	public void TC_VMworld_EU_Interior_3ColControl_HtmlText() throws Exception
	{
		...
		try{	
			...
			aemComponentsObj.VerifyEntered_Title("3 Column");
