...
public class TC_VMworld_EU_Interior_2ColControl_7030_HOLFeedRender{
	...
	@Test
	public void TC_VMworld_EU_Interior_2ColControl_7030_HOLFeedRender() throws Exception
	{
		...
		try{	
			...
			//Entering Details
			aemComponentsObj.columnControlEnterDetails("2 Column","2 columns(70%, 30%)");
			
		
			Thread.sleep(5000);
			
			//Click on column control Drag Component
			aemComponentsObj.clickOnColControlDragComponent("par3");
			Thread.sleep(5000);
