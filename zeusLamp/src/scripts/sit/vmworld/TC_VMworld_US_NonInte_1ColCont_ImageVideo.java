...
public class TC_VMworld_US_NonInte_1ColCont_ImageVideo{
	...
	@Test
	public void TC_VMworld_US_NonInte_1ColCont_ImageVideo() throws Exception
	{
		...
		try{	
			...
			*/
			...
			//Verify Image
			aemComponentsObj.VerifyImage_PublishMode("Lighthouse.jpg");
