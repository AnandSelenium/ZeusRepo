...
public class TC_VMworld_US_Interior_4ColControl_SpecGraphics{
	...
	@Test
	public void TC_VMworld_US_Interior_4ColControl_SpecGraphics() throws Exception
	{
		...
		try{	
			...
			aemComponentsObj.VerifyColumnControlTitle("4 Column");
			//Verify Image
