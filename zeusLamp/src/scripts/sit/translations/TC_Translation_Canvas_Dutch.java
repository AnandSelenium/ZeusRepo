...
public class TC_Translation_Canvas_Dutch{
	...
	public void LAMPTest() throws Exception
	{
		try{	
			...
			String translatedPage=aemstranlationObj.fillFieldsInCreateAndTranslate("Dutch", "Create a new translation project");
			...
			oASelFW.driver.get("http://aem-test-auth-1.vmware.com:8080/sites.html/content/vmware/language-master-sites/nl/my-vmware/onlyAutoQA");
