...
public class TC_Translation_CClamp_UnitedStates{
	...
	public void LAMPTest() throws Exception
	{
		try{	
			...
			oASelFW.driver.get("http://aem-test-auth-1.vmware.com:8080/sites.html/content/vmware/language-master-sites/en/");
			oASelFW.effecta("waitForPageToLoad");
			Thread.sleep(5000);
			...
			oASelFW.driver.get("http://aem-test-auth-1.vmware.com:8080/sites.html/content/vmware/vmware-published-sites/us/my-vmware/onlyAutoQA");
			oASelFW.effecta("waitForPageToLoad");
			Thread.sleep(5000);
			
			//Verifying The Created Page 
			aemSitesObj.Verify_CreatedPage(pageName, "");
