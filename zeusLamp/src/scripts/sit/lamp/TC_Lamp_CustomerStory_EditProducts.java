...
public class TC_Lamp_CustomerStory_EditProducts{
	...
	public void LAMPTest()
	{
		try{	
			...
			aemSizeObj.createProduct();
			Thread.sleep(2000);
			String updatedProduct=aemSizeObj.editProduct();
			...
			aemSizeObj.verify_size("Products",updatedProduct, selenium);
