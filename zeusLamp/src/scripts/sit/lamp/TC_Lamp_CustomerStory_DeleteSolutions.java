...
public class TC_Lamp_CustomerStory_DeleteSolutions{
	...
	public void LAMPTest()
	{
		try{	
			...
			//Navigating To Customer Solution
			...
			//Click On Customer Solution
			aemSizeObj.click_namespace("Customerstories Solution");
			
			//Creating Solution
			String solutionsCreated = aemSizeObj.createSolutions();
			Thread.sleep(2000);
			...
			//Verifying Size 
			aemSizeObj.verify_size("Solution",solutionsCreated, selenium);
