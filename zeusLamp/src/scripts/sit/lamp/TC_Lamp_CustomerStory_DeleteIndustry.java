...
public class TC_Lamp_CustomerStory_DeleteIndustry{
	...
	public void LAMPTest()
	{
		try{	
			...
			//Creating Industry
			String industryCreated = aemSizeObj.createIndustry();
			Thread.sleep(2000);
			...
			//Verifying Size 
			aemSizeObj.verify_size("Industry",industryCreated, selenium);
