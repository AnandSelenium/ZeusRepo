...
public class TC_Lamp_CustomerStory_DeleteProducts{
	...
	public void LAMPTest()
	{
		try{	
			...
			//Navigating To Customer Product
			...
			//Click On Customer Product
			aemSizeObj.click_namespace("Customerstories Product");
			
			//Creating Product
			String productCreated = aemSizeObj.createProduct();
			Thread.sleep(2000);
			...
			//Verifying Size 
			aemSizeObj.verify_size("Products",productCreated, selenium);
