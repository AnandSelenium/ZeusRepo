...
public class TC_Lamp_CustomerStory_EditSolutions{
	...
	public void LAMPTest()
	{
		try{	
			...
			aemSizeObj.createSolutions();
			Thread.sleep(2000);
			String updatedSolution=aemSizeObj.editSolution();
			...
			aemSizeObj.verify_size("Solution",updatedSolution, selenium);
