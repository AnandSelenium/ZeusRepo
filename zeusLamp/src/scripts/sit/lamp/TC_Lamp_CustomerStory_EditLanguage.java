...
public class TC_Lamp_CustomerStory_EditLanguage{
	...
	public void LAMPTest()
	{
		try{	
			...
			aemSizeObj.click_namespace("Customerstories Language");
			aemSizeObj.createLanguage();
			Thread.sleep(2000);
			String updatedLanguage=aemSizeObj.editLanguage();
			...
			aemSizeObj.verify_size("Language",updatedLanguage, selenium);
