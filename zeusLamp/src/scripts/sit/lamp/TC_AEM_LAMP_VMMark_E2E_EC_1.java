...
public class TC_AEM_LAMP_VMMark_E2E_EC_1{
	...
	public void test()
	{
		try{	
			...
			/*oASelFW.driver.get("http://aem-test-auth-1.vmware.com:8080/editor.html/content/vmware/language-master-sites/en/training/uat_qa/lamp/VMMarkLandingPage.html");
			Thread.sleep(10000);
			oASelFW.effecta("waitForPageToLoad");
			Thread.sleep(10000);
			...
			aemCustStoryObj.verifySearchResults_CustomerStoryAfterRollout(VMMark);
