...
public class TC_Lamp_CustomerStory_DeleteLanguage{
	...
	public void LAMPTest()
	{
		try{	
			...
			String languageCreated = aemSizeObj.createLanguage();
			Thread.sleep(2000);
			...
			aemSizeObj.verify_size("Language",languageCreated, selenium);
