...
public class TC_Lamp_CustomerStory_EditIndustry{
	...
	public void LAMPTest()
	{
		try{	
			...
			//Navigating To Customer Industry
			...
			//Click On Customer Industry
			aemSizeObj.click_namespace("Customerstories Industry");
			
			
			aemSizeObj.createIndustry();
			Thread.sleep(2000);
			
			//Updating Industry Name
			String updatedIndustry= aemSizeObj.editIndustry();
			...
			//Verifying Size
			aemSizeObj.verify_size("Industry",updatedIndustry, selenium);
