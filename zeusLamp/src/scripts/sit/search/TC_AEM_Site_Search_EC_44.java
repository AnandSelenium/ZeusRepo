...
public class TC_AEM_Site_Search_EC_44
{
	...
	public void LAMPTest() throws Exception
	{
		try{	
			...
			vmwsearch.searchComponent("VMware");
		
			
			//Verifying Category & Type sub section in Filter By section
			vmwsearch.selectCategoryTypeAndFilterNoResutls("vSphere","Blogs","Video");
			
			
			// verify VMware Recommended Search results of there are no results
			vmwsearch.verifyRecommendedSearchResutls();
		}
		catch (Exception e)
		{
