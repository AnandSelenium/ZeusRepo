...
public class TC_VMware_Canvas_Component{
	...
	public void LAMPTest() throws Exception
	{
		try{	
			...
			//*******************LINK LIST CARD STARTS********************************

			System.out.println("LINK LIST CARD STARTS");
			aemComponentsObj.clickOnTabPanelLinks("Components");
			...
			//Title
			aemComponentsObj.ImageProperties_Horizontal("Resource Title Heading","VMWARE LIST");
			Thread.sleep(5000);
			//Add_Field
			...
			//Title
			aemComponentsObj.ImageProperties_Horizontal("Link Title","VMWARE LIST");
			//Title
			aemComponentsObj.ImageProperties_Horizontal("Alt Title","VMWARE LIST");
			//Brightcove Video ID
			...
			aemComponentsObj.ClickSaveIcon();
			Thread.sleep(5000);
			System.out.println("LINK LIST CARD Ends");
			//*******************LINK LIST CARD Ends********************************
