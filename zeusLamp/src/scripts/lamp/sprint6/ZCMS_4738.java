...
public class ZCMS_4738{
	...
	public void oneTimeSetUp(String prjName,String testEnvironment,String instanceName,String sauceUser,String moduleName,String testSetName) throws InterruptedException
	{
		...
		oASelFW.startSelenium(oASelFW.getURL("AEM_URL1",oASelFW.instanceName));	
	...
	public void LAMPTest() throws Exception
	{
		try{	
			...
			String translatedPage=aemstranlationObj.fillFieldsInCreateAndTranslate("Chinese (China)", "Create a new translation project");
			...
			oASelFW.driver.get("http://aem-test-auth-1.vmware.com:8080/sites.html/content/vmware/language-master-sites/zh_cn/my-vmware/onlyAutoQA");
