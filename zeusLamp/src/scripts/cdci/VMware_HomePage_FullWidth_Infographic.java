...
public class VMware_HomePage_FullWidth_Infographic{
	...
	public void test() throws Exception
	{
		try{	
			...
			oASelFW.driver.get("http://aem-uat-auth-1.vmware.com:8080/sites.html/content/vmware/language-master-sites/en/");
			oASelFW.effecta("waitForPageToLoad");
			Thread.sleep(5000);
			...
			oASelFW.driver.get("http://www-uat.vmware.com/us/my-vmware/onlyAutoQA/"+pageName+".html");
			oASelFW.effecta("waitForPageToLoad");
			Thread.sleep(5000);
