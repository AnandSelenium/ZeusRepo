...
public class Search_Support_Filter
{
	...
	public void oneTimeSetUp(String prjName,String testEnvironment,String instanceName,String sauceUser,String moduleName,String testSetName) throws InterruptedException
	{
		...
		oASelFW.startSelenium(oASelFW.getURL("VMware_Search5",oASelFW.instanceName));	
	}
	@Test
	public void LAMPTest() throws Exception
	{
		try{	
			...
			vmwsearch.verifyScrapperSupportPage();
			...
			vmwsearch.selectCategoryTypeAndFilter("vmware","Blogs","Web");
