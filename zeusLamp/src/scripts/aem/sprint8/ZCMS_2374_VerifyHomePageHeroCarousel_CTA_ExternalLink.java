...
public class ZCMS_2374_VerifyHomePageHeroCarousel_CTA_ExternalLink {
	...
	@Test
	public void ZCMS_2374_VerifyHomePageHeroCarousel_CTA_ExternalLink() throws Exception{
		try{	
			...
			aemComponentObj.ClickHomePageHeroCarousel_CTATitle_LinkBehaviour("Login CTA Button", "https://www.facebook.com");
