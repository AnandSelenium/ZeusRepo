...
public class ZCMS_2579_EditingCollateral{
	...
	public void LAMPTest() throws Exception
	{
		try{	
			...
			//oASelFW.driver.get("http://aem-test-auth-1.vmware.com:8080/cf#/etc/scaffolding/customerstories.html");
			...
			aemCustStoryObj.clickCreatedcustomerStory(customerStory[0]);
			Thread.sleep(5000);
			
			aemCustStoryObj.clickScaffolding();
			
			//oASelFW.driver.get("http://aem-test-auth-1.vmware.com:8080/cf#/content/lamp/customer-story-test/sdgasdgfgg.scaffolding.html");
			
			String newLinkTitle=aemCustStoryObj.editCollateral();
			System.out.println(" New Link Title:-"+newLinkTitle);
			
			aemCustStoryObj.click_update();
			Thread.sleep(5000);
			
			aemCustStoryObj.verifyEditedCollateral(newLinkTitle);
