...
public class  ZCMS_4855_Delete_ChevronCTA_ShouldnotDisplay{
	...
	@Test
	public void ZCMS_4855_Delete_ChevronCTA_ShouldnotDisplay() throws Exception
	{
		try{	
		...
		//	oASelFW.driver.get("http://aem-test-auth-1.vmware.com:8080/editor.html/content/vmware/language-master-sites/en/my-vmware/QAAutomationTest/QAAuto39511.html");
			...
			//Verify Rich Text Entered Value is Configured with Chevron in Read mode
			...
			aahp.clickOnParagraphText("paragraphtext");
			
			//Click on Delete
			aahp.clickOnEdit("Delete");
			
			Thread.sleep(5000);
			
			aahp.clickOnDeleteButtonOnConfirmationBox("Delete");
			
			Thread.sleep(6000);
			
			aemComponentObj.Verify_RichText_DeletedChevronCTA("SampleTestForChevron","Read Mode");
			...
			aemComponentObj.Verify_RichText_DeletedChevronCTA_Preview("SampleTestForChevron","Preview Mode");
			...
			aemComponentObj.Verify_RichText_DeletedChevronCTA("SampleTestForChevron","Publish Mode");
