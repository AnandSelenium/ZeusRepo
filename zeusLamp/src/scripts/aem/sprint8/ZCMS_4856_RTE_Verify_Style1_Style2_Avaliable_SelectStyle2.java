...
public class  ZCMS_4856_RTE_Verify_Style1_Style2_Avaliable_SelectStyle2{
	...
	@Test
	public void ZCMS_4856_RTE_Verify_Style1_Style2_Avaliable_SelectStyle2() throws Exception
	{
		try{	
		...
		//	oASelFW.driver.get("http://aem-test-auth-1.vmware.com:8080/editor.html/content/vmware/language-master-sites/en/my-vmware/QAAutomationTest/QAAuto39511.html");
			...
			cfp.insertTextInRichTextComponentWhenMaxmized("WhiteButton");
			Thread.sleep(5000);
			...
			//Click Style Type
			aemComponentObj.Click_RichText_StyleType("Button White");
			...
			aemComponentObj.Verify_RichText_Value("WhiteButton");
			
			aemComponentObj.Verify_RichText_ButtonColor("btn btn-white","white");
			
			//Verify Style Properties
			aemComponentObj.Verify_RichText_ButtonOutlineSize("WhiteButton","2px");
			
			aemComponentObj.Verify_RichText_FontFamily("WhiteButton", "proxima_novasemibold");
