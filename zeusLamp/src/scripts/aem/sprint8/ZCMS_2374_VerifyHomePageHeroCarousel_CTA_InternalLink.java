...
public class ZCMS_2374_VerifyHomePageHeroCarousel_CTA_InternalLink {
	...
	@Test
	public void ZCMS_2374_VerifyHomePageHeroCarousel_CTA_InternalLink() throws Exception{
		try{	
			...
			//Enter Note URL
			aemComponentObj.EnterTextField_Browse("CTA URL","/content/vmware/language-master-sites/en");
			...
			aemComponentObj.ClickHomePageHeroCarousel_CTATitle_LinkBehaviour_Internal("/content/vmware/language-master-sites/en");
			
			
			//aemComponentObj.ClickHomePageHeroCarousel_CTATitle_LinkBehaviour("Login CTA Button", "/content/vmware/language-master-sites/en/my-vmware/QAAutomationTest/TestHeroCarousel_1");
