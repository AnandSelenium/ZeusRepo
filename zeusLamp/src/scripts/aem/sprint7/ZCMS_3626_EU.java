...
public class ZCMS_3626_EU {
	...
	@Test
	public void ZCMS_3626_EU() throws Exception{
		try{	
			...
			/*oASelFW.driver.get("http://aem-test-auth-1.vmware.com:8080/editor.html/content/vmworld/en/europe/test1232312.html");
			Thread.sleep(4000);*/
