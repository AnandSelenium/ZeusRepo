...
public class TC_ZCMS_5820_Translation_SelectAllSubPages_VerifyUnchecked {
	...
	public void TC_ZCMS_3601_TranslateAssetLinksFromEN_JP() throws Exception{
		try{	
			...
			//aemSitesObj.clickOnRequiredSite("Test1");
			//Thread.sleep(5000);
			...
			aemstranlationObj.SelectLanguages("Japanese");
			
			//Verify Select Languages Checkbox as unchecked
			aemstranlationObj.verifyCheckBox();
			
			
			//Click 
			aemstranlationObj.ClickSelectLanguages_Checkbox();
			
			//Verify Select Languages Checkbox as checked
			aemstranlationObj.verifyCheckBox();
