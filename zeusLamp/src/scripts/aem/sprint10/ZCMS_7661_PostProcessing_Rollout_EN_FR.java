...
public class ZCMS_7661_PostProcessing_Rollout_EN_FR {
	...
	public void test() throws Exception{
		try{	
			...
			langMapp.SelectTranslationLocale("France");
			...
			langMapp.EnterTargetLanguageID("CTA Title_FR");
			...
			langMapp.EnterTargetLanguageID("https://www.vmware.fr.com");
			...
			aemLoginObj.openURL("http://aem-test-auth-1.vmware.com:8080/sites.html/content/vmware/language-master-sites/fr/my-vmware/onlyAutoQA");
			Thread.sleep(10000);
			aemstranlationObj.clickReferences();
			...
			//Click Page path
			aemstranlationObj.clickLiveCopyShortPath("/onlyAutoQA/QA");
			...
			//Click Rollout
			aemstranlationObj.clickLiveCopyRollout_Page();
			...
			aemSitesObj.SelectSearchDirectory("/content/vmware/vmware-published-sites/fr/my-vmware/onlyAutoQA");
			
			Thread.sleep(15000);
			*/
			aemSitesObj.clickOnRequiredSite("France");
			...
			aemstranlationObj.verifyRolloutPagedata("CTA Title_FR");
			Thread.sleep(5000);
