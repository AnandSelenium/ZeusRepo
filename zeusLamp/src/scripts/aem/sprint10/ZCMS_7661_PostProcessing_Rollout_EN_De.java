...
public class ZCMS_7661_PostProcessing_Rollout_EN_De {
	...
	public void test() throws Exception{
		...
		{	oASelFW.driver.manage().timeouts().pageLoadTimeout(600, TimeUnit.SECONDS);
			...
			aemComponentsObj.enterTextInput("vmware-partner-demand-center.jpg", "Assets");
			Thread.sleep(5000);
			...
			Thread.sleep(5000);
			String translatedPage=aemstranlationObj.fillFieldsInCreateAndTranslate("German", "Create a new translation project");
			Thread.sleep(10000);
			...
			langMapp.SelectTranslationLocale("Germany");
			Thread.sleep(10000);
			...
			langMapp.EnterTargetLanguageID("CTA Title_GR");
			langMapp.ClickAdd_LanguageReplace();
			Thread.sleep(5000);
			
			langMapp.ClickAdd();
			langMapp.EnterEnglishID("https://www.vmware.com");
			langMapp.EnterTargetLanguageID("https://www.vmware.gr.com");
			langMapp.ClickAdd_LanguageReplace();
			Thread.sleep(5000);
			...
			aemLoginObj.openURL("http://aem-test-auth-1.vmware.com:8080/sites.html/content/vmware/language-master-sites/de");
			Thread.sleep(10000);
			aemstranlationObj.clickReferences();
			...
			//Click Page path
			aemstranlationObj.clickLiveCopyShortPath("/de/my-vmware");
			...
			aemSitesObj.SelectSearchDirectory("/content/vmware/vmware-published-sites/de/my-vmware/onlyAutoQA");
		...
		/*	//Enter Search keyword
			...
			aemstranlationObj.verifyRolloutPagedata("CTA Title_GR");
			Thread.sleep(5000);
			oASelFW.driver.close();
			Thread.sleep(5000);
