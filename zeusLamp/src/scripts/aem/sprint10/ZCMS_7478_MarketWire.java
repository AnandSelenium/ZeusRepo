...
public class ZCMS_7478_MarketWire {
	...
	public void TC_ZCMS_2324_Events_Entry_01() throws Exception{
		try{	
			...
			aemSitesObj.clickOnRequiredSite("Hungarian");
			...
			aemComponentsObj.enterTextInput("Market Wire Feed Dynamic", "Components");
			
			aemComponentsObj.dragAndDropComponents("Market Wire Feed Dynamic", "Components","");
			Thread.sleep(3000);
			...
			aahp.clickTextComponent("Market Wire Feed Dynamic");
			
			aahp.clickOnTool("CONFIGURE");
			Thread.sleep(5000);

			aemComponentsObj.EnterTextField("Data Size","3");
	        ...
	        List<WebElement> list1 = oASelFW.driver.findElements(By.xpath("//div[@class='faq_block']"));
	        ...
	        for(int j=0,i=1;j<list1.size();j++,i++){  
	        	callist.add(list1.get(j).findElement(By.xpath("//div[@class='faq_block']["+i+"]/a/span/span/p[1]")).getText());
