...
public class ZCMS_3620_Verify_RighthandSideBannerComponent_USInteriorpageWithCarouselTemplate {
	...
	public void ZCMS_3620_Verify_RighthandSideBannerComponent_EUInteriorpageWithCarouselTemplate() throws Exception{
		...
		try{	
			...
			Thread.sleep(5000);
			//oASelFW.driver.get("http://aem-test-auth-1.vmware.com:8080/content/vmworld/en/us/global-content/onlyAutoQA/QAAutoTest59685.html");
			//Thread.sleep(5000);
