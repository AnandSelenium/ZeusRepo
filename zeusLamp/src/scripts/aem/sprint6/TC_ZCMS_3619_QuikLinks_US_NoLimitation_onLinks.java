...
public class TC_ZCMS_3619_QuikLinks_US_NoLimitation_onLinks {
	...
	@Test
	public void TC_ZCMS_3619_QuikLinks_US_NoLimitation_onLinks() throws Exception{
		...
		try{	
			...
			//Click on Existing Template "Global Content"
			//aemSitesObj.clickOnRequiredSite("Global Content");
			...
			//Check Whether Insert Component Empty or not
