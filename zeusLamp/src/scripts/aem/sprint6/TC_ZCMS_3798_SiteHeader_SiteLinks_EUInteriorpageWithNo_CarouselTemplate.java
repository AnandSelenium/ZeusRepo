...
public class TC_ZCMS_3798_SiteHeader_SiteLinks_EUInteriorpageWithNo_CarouselTemplate {
	...
	public void TC_ZCMS_3798_SiteHeader_SiteLinks_USInteriorpageWithNo_CarouselTemplate() throws Exception{
		...
		try{	
			...
			aemComponentsObj.DoubleClickonInsertedComponent("Site Header");
			...
			for(int i=1;i<=2;i++)
			{
				...
				//aemComponentsObj.click_HighlightLinkCheckBox("Highlight link?");
			}
			//click on Save
