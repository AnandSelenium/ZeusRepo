...
public class TC_ZCMS_3802_US_AddFooterComponentAndVerify {
	...
	@Test
	public void TC_ZCMS_3802_US_AddFooterComponentAndVerify() throws Exception{
		...
		try{	
			...
			for(int i=1;i<=n;i++)
			{
				...
				String array1[]={"fatfooter1","fatfooter2"};
