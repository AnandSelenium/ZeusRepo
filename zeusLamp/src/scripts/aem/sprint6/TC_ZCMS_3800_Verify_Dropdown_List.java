...
public class TC_ZCMS_3800_Verify_Dropdown_List {
	...
	public void TC_ZCMS_3601_TranslateAssetLinksFromEN_JP() throws Exception{
		...
		try{	
			...
			/*Thread.sleep(4000);
			oASelFW.driver.get("http://aem-test-auth-1.vmware.com:8080/editor.html/content/vmworld/en/us/global-content/onlyAutoQA/QAAutoTest51538.html");*/
			//Verify Home Page
			...
			samp.VerifyMenuLinks("Countries");
			...
			samp.verify_submenulinks("India",1);
			
			oASelFW.driver.navigate().refresh();
			
			
			Thread.sleep(5000);
			samp.verify_submenulinks("Australia",2);
