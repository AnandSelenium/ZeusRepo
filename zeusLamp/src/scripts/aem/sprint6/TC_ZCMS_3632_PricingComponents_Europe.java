...
public class TC_ZCMS_3632_PricingComponents_Europe {
	...
	@Test
	public void TC_ZCMS_3632_PricingComponents_Europe() throws Exception{
		...
		try{	
			...
			Thread.sleep(4000);
		    //oASelFW.driver.get("http://aem-test-auth-1.vmware.com:8080/editor.html/content/vmworld/en/europe/PriceEurope.html");
			//Verify Home Page
		    //aemHomeObj.verifyHomePage();
