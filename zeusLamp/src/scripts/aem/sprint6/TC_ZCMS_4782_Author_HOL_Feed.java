...
public class TC_ZCMS_4782_Author_HOL_Feed {
	...
	@Test
	public void TC_ZCMS_4782_Author_HOL_Feed() throws Exception{
		...
		try{	
			...
			Thread.sleep(4000);
			//oASelFW.driver.get("http://aem-test-auth-1.vmware.com:8080/editor.html/content/vmworld/en/us/hero.html");
			//Verify Home Page
			...
			//double click on component to add field
			//aemComponentsObj.DoubleClickonInsertedComponent("HOL Feed Render");
			Thread.sleep(3000);
		    ...
		    //Click on HOL Feed Render Component
			samp.click_Verify_HOL_Feed_Render_Component();
