...
public class TC_ZCMS_3636_VerifyExternalSocailLinksOnTwitter {
	...
	public void TC_ZCMS_3636_VerifyExternalSocailLinksOnTwitter() throws Exception{
		...
		try{	
			...
			Thread.sleep(4000);
			//oASelFW.driver.get("http://aem-test-auth-1.vmware.com:8080/editor.html/content/vmworld/en/europe/QAAutoTest92615.html");
			//Verify Home Page
			...
			//aemComponentsObj.DoubleClickonInsertedComponent("Html Text Component");
			
			//samp.single_click_Component("Html Text Component");
			
			samp.click_Edit();
			samp.single_click_Html();
			//samp.single_click_Component("Html Text Component");
			samp.click_onTool("Configure");

			Thread.sleep(5000);

			aemComponentsObj.EnterTextField("Title","VmwareTwitterHashtag");
			...
			//click on View on Twitter link

			aemComponentsObj.click_ViewOnTwitter_Link();
			...
			aemComponentsObj.Verifying_TwitterSocialNWPage("twitter.com");
